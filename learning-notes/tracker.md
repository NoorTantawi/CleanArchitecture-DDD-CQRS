...
**Next action:** Answer Drill 4 (3 outbox scenarios) — see [ADR-004-outbox-pattern.md](ADR-004-outbox-pattern.md#drill-4--still-open)
...
| 4 | ADR-004: Outbox Pattern | 🟡 Content taught, drill open | [ADR-004](ADR-004-outbox-pattern.md) | **Drill 4: PENDING** |
| 5 | ADR-005: Error Management System | ⬜ Not started | — | — |
...
**Phase 0 graduation deliverable:** submit a PR fixing the bug in [bugs-found.md](bugs-found.md) (`AssetErrors.ConcurrencyConflict` hardcoding).

---

## Phase 0 Estimated Completion

~3-4 weeks at current pace (topics 5–11 remaining).
